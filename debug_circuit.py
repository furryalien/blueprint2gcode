...
# Load image
img = Image.open('test_images/test5_circuit.png')
...
# Save debug images
cv2.imwrite('test_output/debug_binary.png', binary)
cv2.imwrite('test_output/debug_dilated.png', dilated)
cv2.imwrite('test_output/debug_skeleton.png', skeleton)
...
cv2.imwrite('test_output/debug_contours.png', debug_img)
