...
# Load image
img = Image.open('test_images/test2_floor_plan.png')
...
# Save debug images
cv2.imwrite('test_output/debug_floor_binary.png', binary)
cv2.imwrite('test_output/debug_floor_skeleton.png', skeleton)

# Highlight stairs area
debug_img = cv2.cvtColor(skeleton, cv2.COLOR_GRAY2BGR)
cv2.rectangle(debug_img, (100, 450), (200, 700), (0, 255, 0), 2)
cv2.imwrite('test_output/debug_floor_stairs_area.png', debug_img)
