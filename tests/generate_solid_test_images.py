...
def create_test_directory():
    ...
    os.makedirs('../test_data/test_images_solid', exist_ok=True)
...
def test1_simple_shapes():
    ...
    img.save('../test_data/test_images_solid/test1_simple_shapes.png')
...
def test2_mixed_solid_outline():
    ...
    img.save('../test_data/test_images_solid/test2_mixed_solid_outline.png')
...
def test3_text_with_solids():
    ...
    img.save('../test_data/test_images_solid/test3_text_with_solids.png')
...
def test4_floor_plan_with_walls():
    ...
    img.save('../test_data/test_images_solid/test4_floor_plan_with_walls.png')
...
def test5_mechanical_part():
    ...
    img.save('../test_data/test_images_solid/test5_mechanical_part.png')
...
def test6_logo_style():
    ...
    img.save('../test_data/test_images_solid/test6_logo_style.png')
...
def test7_circuit_with_pads():
    ...
    img.save('../test_data/test_images_solid/test7_circuit_with_pads.png')
...
def test8_small_details():
    ...
    img.save('../test_data/test_images_solid/test8_small_details.png')
