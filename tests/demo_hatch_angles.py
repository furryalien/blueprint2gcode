...
# Original image
img = Image.open('../test_data/test_images_solid/test1_simple_shapes.png')
...
for angle, ax in zip(angles, output_axes):
    generate_and_visualize(angle, '../test_data/test_output/hatch_demo', ax)

plt.tight_layout()
plt.savefig('../test_data/test_output/hatch_angles_comparison.png', dpi=150, bbox_inches='tight')
