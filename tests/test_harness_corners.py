...
def process_test(test_file, output_dir, viz_dir):
    ...
    input_path = os.path.join('../test_data/test_images_corners', test_file)
...
def main():
    ...
    output_dir = '../test_data/test_output_corners'
    viz_dir = '../visualizations/test_visualizations_corners'
    os.makedirs(output_dir, exist_ok=True)
    os.makedirs(viz_dir, exist_ok=True)
    
    # Get all test images
    test_images = sorted([f for f in os.listdir('../test_data/test_images_corners') if f.endswith('.png')])
