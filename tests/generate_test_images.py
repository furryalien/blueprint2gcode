...
def create_test_image_1_simple_box():
    ...
    img.save('../test_data/test_images/test1_simple_box.png')
...
def create_test_image_2_floor_plan():
    ...
    img.save('../test_data/test_images/test2_floor_plan.png')
...
def create_test_image_3_geometric():
    ...
    img.save('../test_data/test_images/test3_geometric.png')
...
def create_test_image_4_mechanical():
    ...
    img.save('../test_data/test_images/test4_mechanical.png')
...
def create_test_image_5_circuit():
    ...
    img.save('../test_data/test_images/test5_circuit.png')
...
def create_test_image_6_text_labels():
    ...
    img.save('../test_data/test_images/test6_text_labels.png')
...
def create_test_image_7_geodesic_dome():
    ...
    img.save('../test_data/test_images/test7_geodesic_dome.png')
...
def create_test_image_8_interlocking_gears():
    ...
    img.save('../test_data/test_images/test8_interlocking_gears.png')
...
def main():
    ...
    print("\nAll test images created in '../test_data/test_images/' directory")
