...
"""
    ...
    html_file = output_dir / '../test_data/test_results_a6_portrait.html'
...
def main():
    ...
    output_dir = Path('../test_data/test_output_a6_portrait')
    output_dir.mkdir(exist_ok=True)
    
    viz_dir = Path('../visualizations/test_visualizations_a6_portrait')
