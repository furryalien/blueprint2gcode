...
def create_output_directory():
    ...
    os.makedirs('../test_data/test_output_solid', exist_ok=True)
...
def main():
    ...
    test_images_dir = Path('../test_data/test_images_solid')
    ...
    tests = [
        # Basic tests with default parameters
        {
            ...
            'input': '../test_data/test_images_solid/test1_simple_shapes.png',
            'output': '../test_data/test_output_solid/test1_default.gcode',
            'args': []
        },
        {
            'name': 'Test 2: Mixed Solid/Outline (Default)',
            'input': '../test_data/test_images_solid/test2_mixed_solid_outline.png',
            'output': '../test_data/test_output_solid/test2_default.gcode',
            'args': []
        },
        ...
        # Different hatch angles
        {
            ...
            'input': '../test_data/test_images_solid/test1_simple_shapes.png',
            'output': '../test_data/test_output_solid/test1_hatch_0deg.gcode',
            'args': ['--hatch-angle', '0']
        },
        {
            'name': 'Test 1: Vertical Hatch (90°)',
            'input': '../test_data/test_images_solid/test1_simple_shapes.png',
            'output': '../test_data/test_output_solid/test1_hatch_90deg.gcode',
            'args': ['--hatch-angle', '90']
        },
        {
            'name': 'Test 1: Diagonal Hatch (135°)',
            'input': '../test_data/test_images_solid/test1_simple_shapes.png',
            'output': '../test_data/test_output_solid/test1_hatch_135deg.gcode',
        ...
        # Different hatch spacing
        {
            ...
            'input': '../test_data/test_images_solid/test1_simple_shapes.png',
            'output': '../test_data/test_output_solid/test1_hatch_dense.gcode',
            'args': ['--hatch-spacing', '0.5']
        },
        {
            'name': 'Test 1: Sparse Hatch (3.0px)',
            'input': '../test_data/test_images_solid/test1_simple_shapes.png',
            'output': '../test_data/test_output_solid/test1_hatch_sparse.gcode',
        ...
        # Different minimum solid area
        {
            ...
            'input': '../test_data/test_images_solid/test8_small_details.png',
            'output': '../test_data/test_output_solid/test8_min_area_50.gcode',
            'args': ['--min-solid-area', '50']
        },
        {
            'name': 'Test 8: Small Details (min area 200px)',
            'input': '../test_data/test_images_solid/test8_small_details.png',
            'output': '../test_data/test_output_solid/test8_min_area_200.gcode',
            'args': ['--min-solid-area', '200']
        },
        {
            'name': 'Test 8: Small Details (min area 500px)',
            'input': '../test_data/test_images_solid/test8_small_details.png',
            'output': '../test_data/test_output_solid/test8_min_area_500.gcode',
        ...
        # Complex real-world tests
        {
            ...
            'input': '../test_data/test_images_solid/test3_text_with_solids.png',
            'output': '../test_data/test_output_solid/test3_text_solids.gcode',
            'args': []
        },
        {
            'name': 'Test 4: Floor Plan with Walls',
            'input': '../test_data/test_images_solid/test4_floor_plan_with_walls.png',
            'output': '../test_data/test_output_solid/test4_floor_plan.gcode',
            'args': ['--hatch-spacing', '2.0']
        },
        {
            'name': 'Test 5: Mechanical Part',
            'input': '../test_data/test_images_solid/test5_mechanical_part.png',
            'output': '../test_data/test_output_solid/test5_mechanical.gcode',
            'args': ['--hatch-angle', '45']
        },
        {
            'name': 'Test 6: Logo Style',
            'input': '../test_data/test_images_solid/test6_logo_style.png',
            'output': '../test_data/test_output_solid/test6_logo.gcode',
            'args': []
        },
        {
            'name': 'Test 7: Circuit with Pads',
            'input': '../test_data/test_images_solid/test7_circuit_with_pads.png',
            'output': '../test_data/test_output_solid/test7_circuit.gcode',
        ...
        # Paper size variations
        {
            ...
            'input': '../test_data/test_images_solid/test1_simple_shapes.png',
            'output': '../test_data/test_output_solid/test1_a6.gcode',
            'args': ['--paper-size', 'A6']
        },
        {
            'name': 'Test 4: Floor Plan on A3',
            'input': '../test_data/test_images_solid/test4_floor_plan_with_walls.png',
            'output': '../test_data/test_output_solid/test4_floor_plan_a3.gcode',
    ...
    cmd = [
        'python3', '../blueprint2gcode.py',
        '../test_data/test_images_solid/test1_simple_shapes.png',
