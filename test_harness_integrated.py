...
def main():
    ...
    if not Path('test_images_solid').exists():
        print("\nGenerating solid area test images...")
        subprocess.run(['python3', 'generate_solid_test_images.py'], check=True)
    
    # Create output directories
    output_dir = Path('test_output_integrated')
    viz_dir = Path('test_visualizations_integrated')
    ...
    regular_tests = [
        ('test_images/test1_simple_box.png', 'Test 1: Simple Box'),
        ('test_images/test2_floor_plan.png', 'Test 2: Floor Plan'),
        ('test_images/test5_circuit.png', 'Test 5: Circuit'),
        ('test_images/test8_interlocking_gears.png', 'Test 8: Interlocking Gears'),
    ]
    ...
    # Solid area tests
    solid_tests = [
        ('test_images_solid/test1_simple_shapes.png', 'Solid 1: Simple Shapes (No Fill)', []),
        ('test_images_solid/test1_simple_shapes.png', 'Solid 1: Simple Shapes (With Fill)', 
         ['--fill-solid-areas', '--hatch-spacing', '1.5', '--hatch-angle', '45']),
        ('test_images_solid/test2_mixed_solid_outline.png', 'Solid 2: Mixed (With Fill)', 
         ['--fill-solid-areas']),
        ('test_images_solid/test4_floor_plan_with_walls.png', 'Solid 4: Floor Plan Walls (With Fill)', 
         ['--fill-solid-areas', '--hatch-spacing', '2.0']),
        ('test_images_solid/test5_mechanical_part.png', 'Solid 5: Mechanical Part (With Fill)', 
         ['--fill-solid-areas', '--hatch-angle', '45']),
        ('test_images_solid/test7_circuit_with_pads.png', 'Solid 7: Circuit Pads (With Fill)', 
         ['--fill-solid-areas', '--hatch-spacing', '1.5']),
        ('test_images_solid/test8_small_details.png', 'Solid 8: Small Details (min 200px)', 
