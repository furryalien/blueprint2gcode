...
def main():
    ...
    # Define test images
    test_images = [
        ('test_images/test1_simple_box.png', 'test1_simple_box'),
        ('test_images/test2_floor_plan.png', 'test2_floor_plan'),
        ('test_images/test3_geometric.png', 'test3_geometric'),
        ('test_images/test4_mechanical.png', 'test4_mechanical'),
        ('test_images/test5_circuit.png', 'test5_circuit'),
        ('test_images/test6_text_labels.png', 'test6_text_labels'),
        ('test_images/test7_geodesic_dome.png', 'test7_geodesic_dome'),
        ('test_images/test8_interlocking_gears.png', 'test8_interlocking_gears'),
    ]
    ...
    for orientation in orientations:
        ...
        output_dir = Path(f'test_output_all_{orientation}')
        viz_dir = Path(f'test_visualizations_all_{orientation}')
    ...
    html_file = Path('test_results_all.html')
